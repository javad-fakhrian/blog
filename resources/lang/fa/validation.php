...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'Warranty'              => 'گارانتی',
        'image'                 => 'تصویر',
        'body_description'      => 'توضیحات',
        'OrderTracking'         => 'شماره پیگیری',
        'TrackingCode'          => 'شماره پیگیری',
        'method_type'           => 'روش پرداخت',
        'TemporaryPassword'     => 'کد احراز هویت',
        'g-recaptcha-response'     => 'تایید گوگل',
        'DriversPhoneNumber' => 'شماره موبایل راننده' ,
        'DriversLicensePlate' => 'شماره پلاک راننده',
        'ShippingNumber' => 'شماره بارنامه' , 
        'ShippingName' => 'نام باربری' , 
        'trackingSerial' => 'شماره مرسوله',
    ],
];
