        ...
        <main class="container  mx-auto">
            <div class="flex items-center justify-center min-h-screen ">
                <div class="px-8 py-6 mx-4 mt-4 text-right  md:w-1/3 lg:w-1/3 sm:w-1/3">
                    <h3 class="text-2xl font-bold text-center">به ما بپیوندید !</h3>
                    <form action="/register" method="POST">
                        @csrf
                        <div class="mt-4">
                            <div>
                                <label class="block" for="name">نام و نام خانوادگی<label>
                                <input type="text" name="name" id="name" placeholder="پریسا قهرمان" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                                @error('name')
                            ...
                            <div class="mt-4">
                                <label for="password_confirmation" class="block">تکرار رمز عبور<label>
                                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="تکرار رمز عبور" class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                            ...
                            <div class="flex">
                                <button class="w-full px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-900">ایجاد حساب</button>
                            </div>
